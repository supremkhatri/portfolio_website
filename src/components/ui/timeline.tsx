...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="max-w-7xl flex flex-col items-center mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-2xl sm:text-5xl font-extrabold mb-4 mt-4  dark:text-white max-w-4xl">
          A Journery Through My Studies
        </h2>
      </div>
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full  dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full  dark:bg-neutral-800 border  dark:border-neutral-700 p-2" />
              </div>
